...
<!-- 	<?php echo ' <a href="' . esc_url( get_permalink() ) . '"></a> ';?> -->
	<?php 
...
echo $content;	
//  echo ' <a href="' . esc_url( get_permalink() ) . '">click here</a> for more.';																
	
?>			</div>
<?php echo ' <a style="color:blue; "href="' . esc_url( get_permalink() ) . '">Detail  '	?>
				<?php } else {
					the_content();
				}
			} ?>
